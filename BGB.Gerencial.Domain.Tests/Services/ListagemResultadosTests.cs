...
{
    [TestClass]
    public class ListagemResultadosTests
    {
        ...
        [TestMethod]
        [DataRow("23/12/2019", "19/06/2020", "PRE", 0.0045, 1811853.83, 1820279.58)]
        [DataRow("15/01/2020", "13/07/2020", "PRE", 0.0044, 3764258.40, 3773082.81)]
        [DataRow("21/01/2020", "17/07/2020", "PRE", 0.0044, 1748913.83, 1751475.15)]
        [DataRow("12/02/2020", "10/08/2020", "PRE", 0.0042, 1732641.63, 1736761.57)]
        [DataRow("20/02/2020", "18/08/2020", "PRE", 0.0042, 1829846.61, 1832148.84)]
        public void ListarDatasPre(string dataInicial, string dataFinal, string indice, double taxa, double valorContrato, double valorEsperado)
        {
            ...
            Assert.AreEqual(calculo[1].SaldoInicial, valorEsperado);
        }

        [TestMethod]
        [DataRow("16/12/2019", "16/12/2022", "CDI", 0.0045, 2042610.95, 2051360.26)]
        ...
        [TestMethod]
        [DataRow("23/12/2019", "23/12/2022", "CDI", 0.0030, 7142299.66, 7191425.57)]
