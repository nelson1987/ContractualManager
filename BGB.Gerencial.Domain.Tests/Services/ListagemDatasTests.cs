...
{
    [TestClass]
    public class ListagemDatasTests
    {
        ...
        [TestMethod]
        [DataRow("20/12/2019", "18/08/2020", "PRE", 0.0042, "31/12/2019")]
        [DataRow("20/02/2020", "18/08/2020", "PRE", 0.0042, "20/02/2020")]
        public void PrimeiraData(string dataInicial, string dataFinal, string indice, double taxa, string valorEsperado)
        {
            ...
            Assert.AreEqual(calculadora.Datas[0].ToString("dd/MM/yyyy"), valorEsperado);
        }

        [TestMethod]
        [DataRow("20/12/2019", "18/08/2020", "PRE", 0.0042, 9)]
        [DataRow("20/02/2020", "18/08/2020", "PRE", 0.0042, 8)]
        [DataRow("20/02/2020", "18/10/2020", "PRE", 0.0042, 10)]
        public void ListarDatas(string dataInicial, string dataFinal, string indice, double taxa, double valorEsperado)
        {
            Calculadora calculadora = new Calculadora(new Contrato()
            {
                DataInicial = DateTime.Parse(dataInicial),
            ...
            Assert.AreEqual(calculadora.Datas.Count, valorEsperado);
        }

        [TestMethod]
        [DataRow("20/12/2019", "18/08/2020", "PRE", 0.0042, 10)]
        [DataRow("20/02/2020", "18/08/2020", "PRE", 0.0042, 9)]
        [DataRow("20/02/2020", "18/10/2020", "PRE", 0.0042, 11)]
        public void ListarDatasComMovimento(string dataInicial, string dataFinal, string indice, double taxa, double valorEsperado)
        {
            List<Movimento> movimentos = new List<Movimento>();
            movimentos.Add(new Movimento() { Data = DateTime.Parse("2020-02-29"), Valor = 1000.00 });
        ...
        [TestMethod]
        [DataRow("20/12/2019", "18/08/2020", "PRE", 0.0042, 11)]
        [DataRow("01/01/2020", "18/08/2020", "PRE", 0.0042, 11)]
        [DataRow("20/02/2020", "18/08/2020", "PRE", 0.0042, 10)]
        [DataRow("20/02/2020", "18/10/2020", "PRE", 0.0042, 12)]
        public void ListarDatasComMovimentosNoFimDeMes(string dataInicial, string dataFinal, string indice, double taxa, double valorEsperado)
        {
            List<Movimento> movimentos = new List<Movimento>();
            movimentos.Add(new Movimento() { Data = DateTime.Parse("2020-02-29"), Valor = 1000.00 });
            movimentos.Add(new Movimento() { Data = DateTime.Parse("2020-03-31"), Valor = 1000.00 });
